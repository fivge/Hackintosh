 ...
 *
 * Disassembly of DSDT.aml, Thu Apr  5 05:59:49 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00017909 (96521)
 *     Revision         0x02
 *     Checksum         0xA9
 *     OEM ID           "PEGA"
 *     OEM Table ID     "PEGANB"
 *     OEM Revision     0x00000616 (1558)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20091112 (537465106)
 */
DefinitionBlock ("", "DSDT", 2, "PEGA", "PEGANB", 0x00000616)
{
    /*
     * iASL Warning: There were 22 external control methods found during
     * disassembly, but only 14 were resolved (8 unresolved). Additional
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCB38BC18, 0x02B2)
            ...
            Device (GFX0)
            {
                ...
                Device (LCDD)
                {
                    ...
                    Method (_BCL, 0, NotSerialized)  // _BCL: Brightness Control Levels
                    {
                        ...
                        Subtract (0x10, One, Local0)
                        Store (^^^LPCB.IEC.PWAC (Local0), Local1)
                        Store (Divide (Multiply (Local1, 0x64), 0xFF, ), Local2)
                        Store (Local2, Index (PCTG, Zero))
                        Subtract (0x10, 0x04, Local0)
                        Store (^^^LPCB.IEC.PWAC (Local0), Local1)
                        Store (Divide (Multiply (Local1, 0x64), 0xFF, ), Local2)
                ...
                Method (UPBL, 0, NotSerialized)
                {
                    ...
                    If (BRNC)
                    {
                        ...
                        If (LGreaterEqual (Local1, DerefOf (Index (PCTG, 0x11))))
                        {
                            Store (Zero, Local2)
                            Store (One, Local1)
                        }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCACE8E18, 0x10)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (IEC)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (CRS, \_SB.PCI0.LPCB.IEC._Y22._BAS, IB01)  // _BAS: Base Address
                Store (IEM1, IB01)
                Return (CRS)
            }
    ...
    Scope (_SB.PCI0.EHC0.RHUB.PRT1.PRT6)
    {
        Device (CAM0)
        {
            Name (_ADR, 0x06)  // _ADR: Address
            ...
            Device (HS01)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Name (PLDP, Package (0x01)
                    {
                        ...
                        {
                            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                            /* 0008 */  0x69, 0x07, 0x80, 0x03, 0x00, 0x00, 0x00, 0x00 
                        }
                    })
                    Return (PLDP)
                }
            ...
            Device (HS03)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Name (PLDP, Package (0x01)
                    {
                        ...
                        {
                            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                            /* 0008 */  0x69, 0x07, 0x80, 0x04, 0x00, 0x00, 0x00, 0x00 
                        }
                    })
                    Return (PLDP)
                }
    ...
    Scope (_SB)
    {
        Name (CNTB, Buffer (0x10)
        {
            ...
            /* 0008 */  0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 
        })
        ...
        {
            /* 0000 */  0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF,
                ...
                If (LEqual (Arg0, ToUUID ("bdfaef30-aebb-11de-8a39-0800200c9a66")))
                {
                    While (One)
                    {
                        ...
                        ElseIf (LEqual (_T_0, 0x02))
                        {
                            ...
                            Not (Local0, Local1)
                            And (GE00, Local1, GE00)
                            Store (Local0, GS00)
                            Store (Zero, \_GPE.ZODE)
                            SGPL (0x44, One, Zero)
                            Sleep (0xC8)
                            Store (Local0, GS00)
                            Store (One, \_GPE.ZODE)
    ...
    {
        Name (ZODE, One)
        Method (_L13, 0, Serialized)  // _Lxx: Level-Triggered GPE
        {
            Store (Zero, Local0)
            If (LEqual (\_SB.PCI0.SAT0.ZODD.CKST (), Zero))
            {
                Return (Zero)
            }

            Store (RGPL (0x44, One), Local0)
    ...
    Scope (_SB.PCI0.SAT0.ZODD)
    {
        Method (CKST, 0, NotSerialized)
        {
            Return (One)
        }
    }
    ...
    Scope (_SB.PCI0)
    {
        Device (BAT0)
        {
            ...
            {
                If (LNot (^^LPCB.IEC.BATP (Zero)))
                {
                    Return (NBIF)
                }

                If (LEqual (^^LPCB.IEC.GBTT (Zero), 0xFF))
                {
                    Return (NBIF)
                }

                Store (^^LPCB.IEC.BIF9 (), Index (PBIF, 0x09))
                Store (ONAM, Index (PBIF, 0x0C))
                Store (^^LPCB.IEC.BIF0 (Zero), Local0)
                Store (^^LPCB.IEC.BIF1 (Zero), Local1)
                Store (^^LPCB.IEC.BIF2 (Zero), Local2)
                Store (Local2, PLFC)
                Store (^^LPCB.IEC.BIF3 (Zero), Local3)
                Store (^^LPCB.IEC.BIF4 (Zero), Local4)
            ...
            Method (_BST, 0, Serialized)  // _BST: Battery Status
            {
                ...
                If (LNotEqual (^^LPCB.IEC.BIF2 (Zero), PLFC))
                {
                    Notify (BAT0, 0x81)
                }

                Store (^^LPCB.IEC.BSTS (Zero), Local0)
                Store (^^LPCB.IEC.BCRT (Zero), Local1)
                Store (^^LPCB.IEC.BRCP (Zero), Local2)
                Store (^^LPCB.IEC.BVOT (Zero), Local3)
                BATR ()
                If (LNotEqual (Local0, Ones))
                {
                    If (LNotEqual (Local1, Ones))
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            Store (^LPCB.IEC.BCRT (Arg0), Local0)
            BATR ()
    ...
    Scope (\)
    {
        ...
        {
            Store (\_SB.PCI0.LPCB.IEC.BCHG (Arg0), Local0)
            Return (Local0)
        }
    ...
    Scope (WMI0)
    {
        ...
        Method (ASBR, 2, NotSerialized)
        {
            ...
            If (LEqual (BATA, Zero))
            {
                Store (\_SB.PCI0.LPCB.IEC.SMBR (\_SB.PCI0.LPCB.IEC.RDWD, \_SB.PCI0.LPCB.IEC.BADR, REGS, BATN), Local0)
            ...
            If (LEqual (BATA, One))
            {
                Store (\_SB.PCI0.LPCB.IEC.SMBW (\_SB.PCI0.LPCB.IEC.WRWD, \_SB.PCI0.LPCB.IEC.BADR, REGS, BATN, 0x02, BDAT), Local0)
                Store (DerefOf (Index (Local0, Zero)), Local2)
                And (Local2, 0x1F, Local2)
                If (Local2)
                {
            ...
            If (LEqual (BATA, 0x02))
            {
                ...
                Store (\_SB.PCI0.LPCB.IEC.SMBR (\_SB.PCI0.LPCB.IEC.RDBL, \_SB.PCI0.LPCB.IEC.BADR, REGS, BATN), Local0)
        ...
        Method (ASBE, 2, Serialized)
        {
            ...
            If (LEqual (BATA, Zero))
            {
                Store (\_SB.PCI0.LPCB.IEC.RBEP (REGS), Local2)
            ...
            If (LEqual (BATA, One))
            {
                Store (\_SB.PCI0.LPCB.IEC.WBEP (REGS, BDAT), Local2)
                And (Local2, 0x1F, Local2)
                If (Local2)
                {
                    Add (Local2, 0x10, Local2)
        ...
        Method (GTSB, 2, NotSerialized)
        {
            ...
            Store (\_SB.PCI0.LPCB.IEC.SMBR (\_SB.PCI0.LPCB.IEC.RDWD, \_SB.PCI0.LPCB.IEC.BADR, 0x16, Zero), Local0)
        ...
        Method (GPST, 2, NotSerialized)
        {
            ...
            If (LEqual (SORC, One))
            {
                Store (\_SB.PCI0.LPCB.IEC.RPIN (0x02, 0x04), GPCT)
            }
            ElseIf (LEqual (SORC, 0x02))
            {
                Store (\_SB.PCI0.LPCB.IEC.RPIN (0x02, 0x06), Local0)
                If (Local0)
                {
                    Store (Zero, GPCT)
                }
            ...
            {
                Store (\_SB.PCI0.LPCB.IEC.RPIN (0x04, 0x06), Local0)
                If (Local0)
                {
                    Store (Zero, GPCT)
                }
        ...
        Method (SFNS, 2, NotSerialized)
        {
            ...
            \_SB.PCI0.LPCB.IEC.SFNV (FNNB, FNSP)
            Return (Zero)
        }
        ...
        Method (GBTS, 2, NotSerialized)
        {
            ...
            {
                Store (\_SB.PCI0.LPCB.IEC.RPIN (DerefOf (Index (Local1, Zero)), DerefOf (Index (Local1, One))), Local2)
            }
        ...
        Method (GDPI, 2, NotSerialized)
        {
            ...
            {
                \_SB.PCI0.GFX0.GETD ()
                Store (\_SB.ACTD, Local0)
                Store (\_SB.PCI0.GFX0.MD2A (Local0), ODAV)
                Store (\_SB.AVLD, Local1)
                Store (\_SB.PCI0.GFX0.MD2A (Local1), ODPC)
            }
    ...
    Scope (WMI0)
    {
        Method (AGLN, 4, NotSerialized)
        {
            ...
            \_SB.PCI0.LPCB.IEC.MF63 (Arg0, Arg1, Arg2, Arg3)
            \_SB.PCI0.LPCB.IEC.MF30 (Arg0, Arg1, Arg2, Arg3)
            MF1F (Arg0, Arg1, Arg2, Arg3)
            MF61 (Arg0, Arg1, Arg2, Arg3)
        }
    }
    ...
    Scope (WMI0)
    {
        Method (QNTY, 1, NotSerialized)
        {
            If (LGreaterEqual (OSFG, OSW8))
            {
                ...
                ElseIf (LEqual (Arg0, 0x0110))
                {
                    Return (Zero)
                }
                ElseIf (LEqual (Arg0, 0x0111))
                {
                    Return (Zero)
                }
                ElseIf (LEqual (Arg0, 0x0112))
                {
                    Return (Zero)
                }
                ElseIf (LEqual (Arg0, 0x0113))
                {
                    Return (Zero)
                }
                ElseIf (LEqual (Arg0, 0x0114))
                {
                    Return (Zero)
                }
                ElseIf (LEqual (Arg0, 0x010D))
                {
                    Return (Zero)
                }
                ElseIf (LEqual (Arg0, 0x010C))
                {
                    Return (Zero)
                }
            }
    ...
    Scope (WMI0)
    {
        Method (WGLN, 5, NotSerialized)
        {
            ...
            MF65 (Arg0, Arg1, Arg2, Arg3, Arg4)
            ERTC (Arg0, Arg1, Arg2, Arg3, Arg4)
    ...
    Scope (_TZ)
    {
        ...
        ThermalZone (THRM)
        {
            ...
            Method (_TMP, 0, NotSerialized)  // _TMP: Temperature
            {
                ...
                If (LGreaterEqual (Local0, \_SB.TCRT))
                {
                    Store (\_SB.PCI0.LPCB.IEC.RRAM (0x051C), Local2)
                    And (Local2, 0x02, Local2)
                    If (LNot (Local2))
                    {
                        Subtract (\_SB.TCRT, One, Local0)
                    }
                }
    ...
    Scope (_TZ)
    {
        ...
        {
            If (\_SB.PCI0.LPCB.IEC.ECAV ())
            {
                Store (\_SB.PCI0.LPCB.IEC.PCPT, Local0)
        ...
        Method (RCRT, 0, NotSerialized)
        {
            If (\_SB.PCI0.LPCB.IEC.ECAV ())
            {
                Store (\_SB.PCI0.LPCB.IEC.ECRT, Local0)
                If (LLess (Local0, 0x80))
                {
        ...
        Method (RPSV, 0, NotSerialized)
        {
            If (\_SB.PCI0.LPCB.IEC.ECAV ())
            {
                Store (\_SB.PCI0.LPCB.IEC.EPSV, Local0)
                If (LLess (Local0, 0x80))
                {
                    Decrement (Local0)
        ...
        Method (RFAN, 1, NotSerialized)
        {
            If (\_SB.PCI0.LPCB.IEC.ECAV ())
            {
                Store (\_SB.PCI0.LPCB.IEC.TACH (Arg0), Local0)
    ...
    Scope (_SB.PCI0.LPCB.IEC)
    {
        ...
        Method (_Q0B, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            ElseIf (LAnd (WLDP, WWDP))
            {
                Store (Zero, Local0)
                Store (RGPL (0x1C, One), Local0)
                XOr (Local0, One, Local0)
                SGPL (0x1C, One, Local0)
                SGPL (0x16, One, Local0)
            }
            Else
            {
                If (WLDP)
        ...
        Method (_Q0E, 0, NotSerialized)  // _Qxx: EC Query
        {
            If (LGreaterEqual (OSFG, OSVT))
            {
                If (^^^GFX0.PRST ())
                {
                    Store (^^^GFX0.MD2A (^^^GFX0.GETD ()), Local1)
                    If (LNot (And (Local1, One)))
                    {
                        Return (One)
                    }
        ...
        Method (_QA3, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            Store (And (EB0S, One), Local0)
            If (LNotEqual (Local0, Zero))
            {
                Store (And (EB0S, 0x04), Local0)
                If (LNotEqual (Local0, Zero))
                {
                    If (ATKP)
                    {
    ...
    Scope (_SB.PCI0.LPCB.IEC)
    {
        ...
        Method (EC86, 2, NotSerialized)
        {
            ...
            OperationRegion (FE86, SystemMemory, Arg0, Arg1)
            Field (FE86, DWordAcc, NoLock, Preserve)
            {
                Offset (0x08), 
                LV_1,   8, 
                AC_1,   8, 
        ...
        Method (BLAC, 0, NotSerialized)
        {
            ...
            If (LNot (LOr (BATP (Zero), BATP (One))))
            {
                Return (Zero)
            }

            If (LEqual (And (EB0S, One), Zero))
            {
                Return (Zero)
            }

            If (LNot (LAnd (BATP (Zero), BATP (One))))
            {
                If (BATP (Zero))
                {
                    Store (BRCP (Zero), Local0)
                    Store (BIF2 (Zero), Local5)
                }

                If (BATP (One))
                {
                    Store (BRCP (One), Local0)
                    Store (BIF2 (One), Local5)
                }
            }
            Else
            {
                Add (BRCP (Zero), BRCP (One), Local0)
                Add (BIF2 (Zero), BIF2 (One), Local5)
            }

            Multiply (Local0, 0x03E8, Local0)
            Multiply (BL1L, 0x0A, Local4)
            Add (Local4, 0x05, Local4)
            Multiply (Local5, Local4, Local1)
            Multiply (BL2L, 0x0A, Local4)
            Add (Local4, 0x05, Local4)
            Multiply (Local5, Local4, Local2)
            Multiply (One, 0x0A, Local4)
            Add (Local4, 0x05, Local4)
            Multiply (Local5, Local4, Local3)
            Store (Zero, Local7)
            If (LLessEqual (Local0, Local3))
            {
                Store (0x02, Local7)
            }
            ElseIf (LLessEqual (Local0, Local2))
            {
                Store (BL2A, Local7)
            }
            ElseIf (LLessEqual (Local0, Local1))
            {
                Store (BL1A, Local7)
            }
            ...
            If (LGreater (BL2A, Zero))
            {
                If (LEqual (BL2A, One))
                {
                    ...
                    If (LNot (LAnd (BATP (Zero), BATP (One))))
                    {
                        ...
                        {
                            Store (BRCP (Zero), Local0)
                            Store (BIF2 (Zero), Local1)
                        }

                        If (BATP (One))
                        {
                            Store (BRCP (One), Local0)
                            Store (BIF2 (One), Local1)
                        }
                    }
                    Else
                    {
                        Add (BRCP (Zero), BRCP (One), Local0)
                        Add (BRCP (Zero), BIF2 (One), Local1)
                    }

                    Multiply (Local0, 0x03E8, Local0)
                    Multiply (BL2L, 0x0A, Local2)
                    Add (Local2, 0x05, Local2)
                    Multiply (Local1, Local2, Local2)
                    If (LLessEqual (Local0, Local2))
                    {
                        WRAM (0x06A3, One)
                    }
                    Else
    ...
    Scope (_SB)
    {
        Device (LID)
        {
            ...
            {
                Store (One, Local0)
                Store (^^PCI0.LPCB.IEC.RPIN (0x04, 0x06), Local0)
                If (LEqual (Local0, Ones))
                {
                    Store (One, Local0)
                }
    ...
    Scope (WMI0)
    {
        Method (ERTC, 5, NotSerialized)
        {
            ...
            If (LNotEqual (Arg3, 0x85))
            {
                Return (Zero)
            }

            OperationRegion (FM30, SystemMemory, Arg0, 0x10)
            Field (FM30, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                STAS,   8, 
                REST,   8, 
            ...
            \_SB.PCI0.LPCB.IEC.ECXT (0xC2, WDAY, HOUR, TMIN, TSEC, Zero)
            And (STAS, 0xFE, STAS)
            Or (STAS, 0x80, STAS)
            Return (Zero)
        }

        Method (MF65, 5, NotSerialized)
        {
            If (LNotEqual (Arg2, 0x65))
            {
                Return (Zero)
            }
        ...
        Method (M651, 2, NotSerialized)
        {
            OperationRegion (FM65, SystemMemory, Arg0, 0x09)
            Field (FM65, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                STAS,   8, 
                REST,   8, 
        ...
        Method (M653, 2, NotSerialized)
        {
            OperationRegion (FM65, SystemMemory, Arg0, 0x0A)
            Field (FM65, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                STAS,   8, 
        ...
        Method (M654, 2, NotSerialized)
        {
            OperationRegion (FM65, SystemMemory, Arg0, 0x0B)
            Field (FM65, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                STAS,   8, 
            ...
            If (LEqual (PLCY, Zero))
            {
                \_SB.PCI0.LPCB.IEC.WRAM (0x0628, 0x5F)
                \_SB.PCI0.LPCB.IEC.WRAM (0x0629, 0x64)
            }

            If (LEqual (PLCY, One))
            {
                \_SB.PCI0.LPCB.IEC.WRAM (0x0628, LCAP)
                \_SB.PCI0.LPCB.IEC.WRAM (0x0629, HCAP)
            }
        ...
        Method (PSPM, 3, NotSerialized)
        {
            OperationRegion (FM65, SystemMemory, Arg0, 0x18)
            Field (FM65, ByteAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                STAS,   8, 
            ...
            If (LEqual (QORS, One))
            {
                ...
                Else
                {
                    ...
                    ShiftLeft (WDAY, One, Local1)
                    Store (Local1, Index (Local0, 0x04))
                    ShiftLeft (SHOU, 0x08, Local2)
                    Add (Local2, SMIN, Local2)
                    ShiftLeft (EHOU, 0x08, Local3)
                    Add (Local3, EMIN, Local3)
                    If (LLessEqual (Local2, Local3))
                    {
                        Store (Local1, Index (Local0, 0x08))
                    }
                    Else
                    {
                    ...
                    Store (0xC3, Index (Local0, Zero))
                    Store (PARA, Index (Local0, One))
                    Store (One, Index (Local0, 0x02))
                    Store (Zero, Index (Local0, 0x03))
                    Store (SHOU, Index (Local0, 0x05))
                    Store (SMIN, Index (Local0, 0x06))
                    Store (SSEC, Index (Local0, 0x07))
                    Store (EHOU, Index (Local0, 0x09))
                    Store (EMIN, Index (Local0, 0x0A))
                    Store (ESEC, Index (Local0, 0x0B))
                    \_SB.PCI0.LPCB.IEC.ECLC (Local0)
                    Store (Zero, RORS)
                }
            }
            ...
            If (LEqual (QORS, 0x02))
            {
                \_SB.PCI0.LPCB.IEC.WRAM (0x062A, PARA)
                Store (Zero, RORS)
            }
            ...
            If (LEqual (QORS, 0x03))
            {
                ...
                Else
                {
                    \_SB.PCI0.LPCB.IEC.ECXT (0xC3, PARA, Zero, Zero, Zero, Zero)
                    Store (Zero, RORS)
                }
            }
            ...
            If (LEqual (QORS, 0x04))
            {
                If (LEqual (PARA, Zero))
                {
                    \_SB.PCI0.LPCB.IEC.ECXT (0xC7, Zero, Zero, Zero, Zero, Zero)
                }

                If (LEqual (PARA, One))
                {
                    \_SB.PCI0.LPCB.IEC.ECXT (0xC7, 0x80, Zero, Zero, Zero, Zero)
                }
    ...
    Scope (WMI0)
    {
        ...
        Name (MAGN, 0x14)
        Name (RSRV, 0x0A)
        Name (SMPD, Package (0x19) {})
        Name (SFLG, Zero)
        Method (PPWR, 0, NotSerialized)
        {
            Store (\_SB.PCI0.LPCB.IEC.RRAM (0x0279), Local0)
            Store (Zero, Local1)
            If (LEqual (Local0, Zero))
            {
                Store (0x41, Local1)
        ...
        Method (CPWR, 0, NotSerialized)
        {
            Store (\_SB.PCI0.LPCB.IEC.B0CC, Local0)
            If (LGreaterEqual (Local0, 0x8000))
            {
                Subtract (0xFFFF, Local0, Local0)
                Add (Local0, One, Local0)
                Store (\_SB.PCI0.LPCB.IEC.B0VL, Local1)
                Multiply (Local1, Local0, Local0)
                Divide (Local0, 0x000F4240, Local2, Local1)
            }
            Else
            {
                Store (\_SB.PCI0.LPCB.IEC.SYSC, Local1)
                Multiply (UNIT, Local1, Local1)
                Multiply (0x13, Local1, Local1)
                Divide (Local1, MAGN, Local2, Local1)
                Divide (Local1, RSRV, Local2, Local1)
        ...
        Method (LDPM, 0, NotSerialized)
        {
            \_SB.PCI0.LPCB.IEC.WRAM (0x053A, DerefOf (Index (SMPD, Zero)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x053B, DerefOf (Index (SMPD, One)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x053C, DerefOf (Index (SMPD, 0x02)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x053D, DerefOf (Index (SMPD, 0x03)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x053E, DerefOf (Index (SMPD, 0x04)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x0543, DerefOf (Index (SMPD, 0x05)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x0544, DerefOf (Index (SMPD, 0x06)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x0545, DerefOf (Index (SMPD, 0x07)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x0546, DerefOf (Index (SMPD, 0x08)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x0547, DerefOf (Index (SMPD, 0x09)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x054B, DerefOf (Index (SMPD, 0x0A)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x054C, DerefOf (Index (SMPD, 0x0B)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x054D, DerefOf (Index (SMPD, 0x0C)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x054E, DerefOf (Index (SMPD, 0x0D)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x054F, DerefOf (Index (SMPD, 0x0E)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C6, DerefOf (Index (SMPD, 0x0F)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C7, DerefOf (Index (SMPD, 0x10)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C8, DerefOf (Index (SMPD, 0x11)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C9, DerefOf (Index (SMPD, 0x12)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CA, DerefOf (Index (SMPD, 0x13)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CB, DerefOf (Index (SMPD, 0x14)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CC, DerefOf (Index (SMPD, 0x15)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CD, DerefOf (Index (SMPD, 0x16)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CE, DerefOf (Index (SMPD, 0x17)))
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CF, DerefOf (Index (SMPD, 0x18)))
        }

        Method (EDPM, 0, NotSerialized)
        {
            If (LEqual (SFLG, Zero))
            {
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x053A), Index (SMPD, Zero))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x053B), Index (SMPD, One))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x053C), Index (SMPD, 0x02))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x053D), Index (SMPD, 0x03))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x053E), Index (SMPD, 0x04))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x0543), Index (SMPD, 0x05))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x0544), Index (SMPD, 0x06))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x0545), Index (SMPD, 0x07))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x0546), Index (SMPD, 0x08))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x0547), Index (SMPD, 0x09))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x054B), Index (SMPD, 0x0A))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x054C), Index (SMPD, 0x0B))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x054D), Index (SMPD, 0x0C))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x054E), Index (SMPD, 0x0D))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x054F), Index (SMPD, 0x0E))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05C6), Index (SMPD, 0x0F))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05C7), Index (SMPD, 0x10))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05C8), Index (SMPD, 0x11))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05C9), Index (SMPD, 0x12))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05CA), Index (SMPD, 0x13))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05CB), Index (SMPD, 0x14))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05CC), Index (SMPD, 0x15))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05CD), Index (SMPD, 0x16))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05CE), Index (SMPD, 0x17))
                Store (\_SB.PCI0.LPCB.IEC.RRAM (0x05CF), Index (SMPD, 0x18))
                Store (One, SFLG)
            }

            \_SB.PCI0.LPCB.IEC.WRAM (0x053A, 0x58)
            \_SB.PCI0.LPCB.IEC.WRAM (0x053B, 0x58)
            \_SB.PCI0.LPCB.IEC.WRAM (0x053C, 0x58)
            \_SB.PCI0.LPCB.IEC.WRAM (0x053D, 0x58)
            \_SB.PCI0.LPCB.IEC.WRAM (0x053E, 0x58)
            \_SB.PCI0.LPCB.IEC.WRAM (0x0543, 0x0C)
            \_SB.PCI0.LPCB.IEC.WRAM (0x0544, 0x0C)
            \_SB.PCI0.LPCB.IEC.WRAM (0x0545, 0x0C)
            \_SB.PCI0.LPCB.IEC.WRAM (0x0546, 0x0C)
            \_SB.PCI0.LPCB.IEC.WRAM (0x0547, 0x0C)
            \_SB.PCI0.LPCB.IEC.WRAM (0x054B, 0xDF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x054C, 0xDF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x054D, 0xDF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x054E, 0xDF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x054F, 0xDF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C6, 0x1B)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C7, 0xFF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C8, 0x1B)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05C9, 0xFF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CA, 0x1B)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CB, 0xFF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CC, 0x1B)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CD, 0xFF)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CE, 0x1B)
            \_SB.PCI0.LPCB.IEC.WRAM (0x05CF, 0xFF)
        }
    }
    ...
    Scope (_SB.PCI0.P0P2.VGA)
    {
        ...
        Method (GETS, 0, Serialized)
        {
            ...
            ElseIf (LEqual (^^^LPCB.IEC.RPIN (0x09, 0x04), One))
            {
                Return (0x03)
            }
            Else
    ...
    Scope (_SB.PCI0.P0P2.VGA)
    {
        OperationRegion (GFXH, SystemMemory, NPXB, 0x1000)
        Field (GFXH, DWordAcc, NoLock, Preserve)
        {
            Offset (0x40), 
            SID2,   32, 
            Offset (0x488), 
    ...
    {
        Name (MSD3, Zero)
        OperationRegion (PCMD, SystemMemory, 0xF8008000, 0x0FF0)
        Field (PCMD, ByteAcc, NoLock, Preserve)
        {
            Offset (0x04), 
            CMDR,   8
        }
        ...
        PowerResource (PG00, 0x00, 0x0000)
        {
            ...
            {
                If (LAnd (LEqual (MSHY, 0xAA), LGreaterEqual (OSFG, OSWB)))
                {
                    If (LEqual (MSD3, 0x03))
                    {
                        Store (0x33, DBG8)
                        ...
                        If (LEqual (NVGT, 0x5A))
                        {
                            Or (And (^^VGA.ELCT, 0x43), And (^^VGA.LCTL, 0xFFBC), ^^VGA.LCTL)
                        }
            ...
            Method (_OFF, 0, Serialized)  // _OFF: Power Off
            {
                If (LAnd (LEqual (MSHY, 0xAA), LGreaterEqual (OSFG, OSWB)))
                {
                    If (LEqual (MSD3, Zero))
                    {
                        ...
                        {
                            ^^VGA.SAVO ()
                            Store (^^VGA.LCTL, ^^VGA.ELCT)
                            Store (^^VGA.EMLW, ^^VGA.DMLW)
                            ^^VGA.SPP0 ()
                        }
    ...
    Scope (WMI0)
    {
        Method (MF61, 4, NotSerialized)
        {
            If (LNotEqual (Arg1, 0x61))
            {
                Return (Zero)
            }
            ...
            OperationRegion (FM60, SystemMemory, Arg0, 0x08)
            Field (FM60, DWordAcc, NoLock, Preserve)
            {
                Offset (0x06), 
                SM60,   8, 
                EM60,   8
        ...
        Method (G611, 2, NotSerialized)
        {
            ...
            OperationRegion (\F600, SystemMemory, Arg0, Arg1)
            Field (F600, DWordAcc, NoLock, Preserve)
            {
                Offset (0x08), 
                OMSD,   16, 
                OMID,   16
        ...
        Method (GINT, 0, NotSerialized)
        {
            If (LGreaterEqual (OSFG, OSW8))
            {
                \_SB.PCI0.LPCB.IEC.WRAM (0x0617, Or (\_SB.PCI0.LPCB.IEC.RRAM (0x0617), One))
            }
            Else
            {
                \_SB.PCI0.LPCB.IEC.WRAM (0x0617, And (\_SB.PCI0.LPCB.IEC.RRAM (0x0617), 0xFE))
            }
        }
    }
    ...
    Scope (_SB)
    {
        Device (PEHS)
        {
            Name (_HID, "PTK0001")  // _HID: Hardware ID
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (LGreaterEqual (OSFG, OSW8))
                {
    ...
    Scope (\)
    {
        ...
        {
            \_SB.PCI0.LPCB.IEC.WRAM (0x07FE, 0x80)
            \_SB.PCI0.LPCB.IEC.SMBW (\_SB.PCI0.LPCB.IEC.WRWD, \_SB.PCI0.LPCB.IEC.BADR, Zero, Zero, 0x02, 0x10)
            \_SB.PCI0.LPCB.IEC.SMBW (\_SB.PCI0.LPCB.IEC.WRWD, \_SB.PCI0.LPCB.IEC.BADR, Zero, Zero, 0x02, 0x10)
        }

        Method (GLID, 0, Serialized)
        {
            Return (\_SB.PCI0.LPCB.IEC.RPIN (0x04, 0x06))
        }
        ...
        Method (ACPS, 0, Serialized)
        {
            Store (\_SB.PCI0.LPCB.IEC.RPIN (0x02, 0x04), Local0)
            Return (Local0)
        }
